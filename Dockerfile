...
## $ docker buildx build --provenance=true --sbom=true --platform linux/amd64,linux/arm64 -t digiserve/ab-migration-manager:master --push .
...
LABEL org.opencontainers.image.title="Migration Manager" \
   org.opencontainers.image.description="Utility for applying DB migrations to a running site" \
